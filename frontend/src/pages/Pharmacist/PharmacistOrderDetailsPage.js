          ...
          <Col md={8}>
            ...
            <Row>
              <Col md={6}>
                <h2>Shipping</h2>
                <b>Name</b>
                {userData?.name || 'Isuru Kodikara'}
                <br />
                <b>Address</b>:{' '}
                {userData?.address ||
                  '141,panadura Road, Horana, Kalutara, Sri Lanka'}{' '}
                <br />
                <b>ZipCode</b>: {userData?.zipCode || '57729'} <br />
                <b>Phone</b>: {userData?.phoneNumber || '071437360'}
                <br />
              ...
              <Row>
                ...
                <Col>
                  <Alert className="mt-3" variant="success">
                    Paid on{' '}
                    {`${new Date(paidDate).getFullYear()}-${new Date(
                      paidDate
                    ).getMonth()}-${new Date(paidDate).getDay()}`}
                  </Alert>
                </Col>
              </Row>
            </Row>
              ...
              {orderItems.map((item) => (
                ...
                >
                  <Typography variant="h6">
                    Name: <span style={{ color: 'red' }}>{item.name}</span>
                  </Typography>
                  <Typography>
          ...
          <Col md={4}>
            <ListGroup>
              ...
              <ListGroup.Item>
                ...
                <span className="fw-bold">{(orderTotal * 1.1).toFixed(2)}</span>
              </ListGroup.Item>
              <ListGroup.Item>
